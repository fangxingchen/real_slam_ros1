...
gnome-terminal -t "carto gmapping save" -- bash -c "cd /home/ubuntu/Cartographer/Cartographer_Locatization && source install_isolated/setup.bash && rosservice call /write_state \"{filename: '/home/ubuntu/Cartographer/Cartographer_Locatization/src/cartographer_ros/cartographer_ros/map/carto_mapf.pbstream'}\"; exec bash"
sleep 5
